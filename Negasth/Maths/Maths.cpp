...
Negasth::Maths::Vector2d Negasth::Maths::getYawPitch(Vector3d playerPos, Vector3d facingPos)
{
...
Negasth::Maths::Vector3d Negasth::Maths::getCameraVector(Vector2d cameraRot, double distance)
{
...
double Negasth::Maths::cropAngle180(double angle)
{
...
double Negasth::Maths::cropAngle360(double angle)
{
...
double Negasth::Maths::worldToScreen(Vector3d world_pos, Matrix modelView, Matrix projection, int screenWidth, int screenHeight, Vector2d& screen_pos)
{
	Matrix world_matrix =
	{
...
Negasth::Maths::Vector3d::Vector3d()
{
}

Negasth::Maths::Vector3d::Vector3d(double x, double y, double z)
{
	this->x = x;
	this->y = y;
	this->z = z;
...
Negasth::Maths::Vector3d Negasth::Maths::Vector3d::operator-(const Vector3d& other_vector)
{
...
Negasth::Maths::Vector3d Negasth::Maths::Vector3d::operator*(double coef)
{
	return Vector3d(x * coef, y * coef, z * coef);
}

double Negasth::Maths::Vector3d::distance()
{
	return std::sqrt(x*x + y*y + z*z);
}

Negasth::Maths::Vector2d::Vector2d()
{
}

Negasth::Maths::Vector2d::Vector2d(double x, double y)
{
	this->x = x;
	this->y = y;
}

Negasth::Maths::Vector2d Negasth::Maths::Vector2d::operator-(const Vector2d& other_vector)
{
...
Negasth::Maths::Vector2d Negasth::Maths::Vector2d::operator*(double coef)
{
	return Vector2d(x * coef, y * coef);
}

Negasth::Maths::Vector2d Negasth::Maths::Vector2d::crop180()
{
	return Vector2d(cropAngle180(x), cropAngle180(y));
}

double Negasth::Maths::Vector2d::distance()
{
	return std::sqrt(x * x + y * y);
}

Negasth::Maths::Matrix::Matrix(int line_number, int column_number, double fill_number) :
...
Negasth::Maths::Matrix::Matrix(const Matrix& other_matrix) :
...
Negasth::Maths::Matrix::Matrix(std::initializer_list<std::initializer_list<double>> init) :
...
Negasth::Maths::Matrix& Negasth::Maths::Matrix::operator=(const Matrix& other_matrix)
{
...
double* Negasth::Maths::Matrix::operator[](int index)
{
...
Negasth::Maths::Matrix::operator bool() const
{
	return is_valid();
}

Negasth::Maths::Matrix Negasth::Maths::Matrix::operator*(const Matrix& other_matrix) const
{
...
bool Negasth::Maths::Matrix::is_valid() const
{
	return line_number && column_number;
}

std::string Negasth::Maths::Matrix::to_string() const
{
	std::string result{};
	for (int i = 0; i < line_number; i++)
	{
...
void Negasth::Maths::Matrix::destroy_data()
{
	if (data)
	{
		for (int i = 0; i < line_number; ++i)
